...
let group2ImagesArray = [
  ...
  "./driftwoodObstacleImageChoices/knittingGranny.svg",
  "./driftwoodFinal.svg",
];
...
function renderObstacles(obstacleType) {
  if (obstacleType === "driftwood") {
    ...
    if (
      randomDriftwoodImagesSrc === "./driftwoodObstacleImageChoices/lilyPad.svg"
    ) {
      driftwood = {
        type: "driftwood",
        img: randomDriftWoodImages,
    ...
    if (
      randomBeaverImagesSrc === "./beaverObstacleImageChoices/paperBoat.svg"
    ) {
      beaver = {
        type: "beaver",
        img: randomBeaverImages,
    ...
    if (randomBeaverImagesSrc === "./beaverObstacleImageChoices/sirOtter.svg") {
      beaver = {
        type: "beaver",
        img: randomBeaverImages,
        x: randomBeaverX,
